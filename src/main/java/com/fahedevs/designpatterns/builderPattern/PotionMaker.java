...
public abstract class PotionMaker {
    ...
    protected boolean prepareAndAddArmadilloBile() throws PotionMakingFeasibilityViolation {
        return false;
    }

    protected boolean prepareAndAddHellebore() throws PotionMakingFeasibilityViolation {
        return false;
    }
    ...
    protected boolean prepareAndAddRoseThorns() throws PotionMakingFeasibilityViolation {
        return false;
    }

    protected boolean prepareAndAddPeppermint() throws PotionMakingFeasibilityViolation {
        return false;
    }
    ...
    public abstract void makePotion() throws PotionMakingFeasibilityViolation;
